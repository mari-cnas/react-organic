...
const BlogCardBottom =({image,imgposition, title,description,children}) => (
    <BlogCardContainer className="w-100 d-flex flex-column flex-md-row flex-lg-column mb-5 px-0">
            <div className="col col-12 col-md-6 col-lg-12 card-body py-5 px-4 order-2 order-md-1" >
            ...
            <img src={image} className="col col-12 col-md-4 col-lg-12 img-fluid px-0 order-1 order-md-2"  alt="..." />
    </BlogCardContainer>
